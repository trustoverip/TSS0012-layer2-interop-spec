# Title (Ex. 0000: Deliverable Name) { #index-title-ex.-0000-deliverable-name }
...
The formal names for each state are important, as they are used in
...
Therefore, we allow a protocol to **adopt** messages into its namespace.
